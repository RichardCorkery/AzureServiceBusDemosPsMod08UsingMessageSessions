...
namespace RfidCheckout.TagReader
{
    class TagReaderConsole
    {
        static async Task Main(string[] args)
        {
            ...
            //Step 2 for Correlation and Session Demo
            ...
            while (position < 10)
            {
                ...
                // Step 2: Show the MessageId. This is important since this value is what is used to identify duplicate messages
